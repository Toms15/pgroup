...
jQuery(document).ready(function(){
  ...
  // ----------------------------------------
  if($('#keywords').length) {
    var app = document.getElementById('keywords');
  ...
  jQuery(function() {
    function initializeMapMG() {       
      var mapOptions = {
        center: new google.maps.LatLng(41.8809623983841, 12.50842800103069),
        zoom: 16,
      ...
      var marker = new google.maps.Marker({
        position: new google.maps.LatLng(41.887541358996835, 12.515082439298576),
        map: map,
        // icon: icon
      });
    }
    function initializeMapCS() {       
      var mapOptions = {
        center: new google.maps.LatLng(41.887541358996835, 12.515082439298576),
        zoom: 16,
        disableDefaultUI: true,
        scrollwheel: false
      };
      ...
      var marker = new google.maps.Marker({
        position: new google.maps.LatLng(41.8809623983841, 12.50842800103069),
        map: map,
        // icon: icon
      });
    }
